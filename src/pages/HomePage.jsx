...
import KnowledgeIndexGraphic from '../components/KnowledgeIndexGraphic.jsx';
    ...
    <div className="page home-page page-enter">
      ...
      <section className="reader-note">
        ...
        <div className="reader-heading">
          <span className="eyebrow">致读者</span>
          <h2>先描述发生了什么，再看可能相关的线索。</h2>
        </div>
      ...
      <section className="collection-block">
        <div className="section-heading">
          <span className="editorial-section-number" aria-hidden="true">03</span>
